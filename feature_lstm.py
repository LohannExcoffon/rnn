...
X_high = high_scaler_X.fit_transform(data[features])
y_high = high_scaler_y.fit_transform(data[['High']])
...
X_low = low_scaler_X.fit_transform(data[features])
y_low = low_scaler_y.fit_transform(data[['Low']])
...
X_volume = volume_scaler_X.fit_transform(data[features])
y_volume = volume_scaler_y.fit_transform(data[['Volume']])
